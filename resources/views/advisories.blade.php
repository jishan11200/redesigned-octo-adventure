...
<head>
  ...
  <title>Advisories | Silk Container Lines Ltd</title>
...
<body>
  ...
  <main id="main">
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
        <h2 class="text-center">Advisories</h2><br><br>
       <div class="row">
          <div class="col-lg-4">
            <div class="card" style="height: 450px;">
              <img src="assets/img/advisories/Retail-logistics.jpg" class="card-img-top" alt="..." style="height: 200px;" >
              ...
              <div class="card-body">
                ...
                <div class="card-text">
                  At Silk Container Lines Ltd, we understand the dynamic and fast-paced nature of the retail industry. Our retail freight forwarding services are designed to seamlessly connect manufacturers, suppliers, and retailers, ensuring that your products reach the shelves efficiently, on time, and in optimal condition.
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card" style="height: 450px;">
                 <img src="assets/img/advisories/automotive-logistics.jpg" class="card-img-top " alt="..." style="height: 200px;">
              ...
              <div class="card-body">
                ...
                <div class="card-text">
                  Silk Container Lines Ltd specializes in automotive freight forwarding, offering tailored solutions for the seamless transportation of vehicles and parts globally. With expertise in customs compliance, multi-modal logistics, and temperature-sensitive shipments, we optimize the automotive supply chain, ensuring efficient deliveries and meeting industry-specific challenges.
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4">
            <div class="card" style="height: 450px;">
                <img src="assets/img/advisories/chemical.jpg" class="card-img-top" alt="..." style="height: 200px;">
              ...
              <div class="card-body">
                ...
                <div class="card-text">
                  Silk Container Lines Ltd excels in freight forwarding services for the chemical industry, providing specialized solutions for the safe and compliant transportation of chemicals globally. Our services encompass rigorous adherence to regulatory standards, expertise in handling hazardous materials, and a commitment to environmental safety. 
                </div>
              </div>
            </div>
          </div>
...
<div class="row">
  <div class="col-lg-4">
    <div class="card">
      <img src="assets/img/advisories/Technology.png" class="card-img-top" alt="..." style="height: 200px;">
      ...
      <div class="card-body">
        ...
        <div class="card-text">
         <p>Silk Container Lines Ltd leads in technology-driven freight forwarding, leveraging cutting-edge solutions for efficient and transparent logistics. Our services include real-time tracking, digital documentation, and integration of innovative technologies to enhance visibility across the supply chain.</p>
        </div>
      </div>
    </div>
  </div>
      {{-- <div class="col-lg-4">
        <div class="card">
            <img src="assets/img/ocean/ocean-freight1.jpg" class="card-img-top" alt="...">
          ...
          <div class="card-body">
            ...
            <div class="card-text">
              Lorem ipsum, dolor sit amet consectetur adipisicing elit. Nostrum, commodi?Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos praesentium, quae amet officia voluptate quam ducimus molestias cupiditate ipsam delectus?
            </div>
          </div>
        </div>
      </div> --}}

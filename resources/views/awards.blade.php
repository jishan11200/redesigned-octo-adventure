...
<head>
  ...
  <title>Awards and Certificate | Silk Container Lines Ltd</title>
        ...
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              <h3>Quality in Business Certification</h3>
              <p class="fst-italic">
            ...
            <div class="col-lg-6">
                <img src="assets/img/certificate/Quality-in-Business-Certification-min.jpg" class="img-fluid" alt="">
              </div>
          </div>
    ...
    <!-- End About Section -->
     ...
     <section class="about" data-aos="fade-up">
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6">
              <img src="assets/img/certificate/GLOBALIA_Membership_Certificate.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0">
              <h3>Certificate of Globalia Membership</h3>
              <p class="fst-italic">

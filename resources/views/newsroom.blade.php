...
<head>
  ...
  <title>Newsroom | Silk Container Lines Ltd</title>
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
       ...
       {{-- <div class="row">
        <div class="col-lg-4">
          <div class="card">
            <img src="assets/img/5.jpg" class="card-img-top h-50" alt="..." >
            <div class="card-body">
              <h5 class="card-title">Silk Container Lines Ltd's News</h5>
        ...
        <div class="col-lg-4">
          <div class="card">
            <img src="assets/img/ocean/ocean-freight1.jpg" class="card-img-top h-50" alt="...">
            <div class="card-body">
              <h5 class="card-title">Silk Container Lines Ltd's News</h5>
              <p class="card-text">This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
            </div>
       ...
       <div class="row">
        ...
        <div class="col-lg-4">
          <div class="card">
            <img src="{{ asset('public/uploads/newsroom/' . $newsroom->image) }}" class="card-img-top h-50" alt="..." >
            <div class="card-body">
              <h5 class="card-title">{{ $newsroom->title }}</h5>
              <p class="card-text"> {{ $newsroom->sub_title }}</p>
            </div>
          </div>
        </div>
        <br>

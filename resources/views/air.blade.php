...
<head>
  ...
  <title>Air Freight | Silk Container Lines Ltd</title>
  ...
  <main id="main">
    ...
    <section class="about" data-aos="fade-up">
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6">
            <img src="assets/img/air/a2.jpg" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0">
            <h3>Air Freight</h3>
            <p class="text-justify">
              In today’s business world, air freight plays a critical role in your company’s global supply chain. Your clients have set the bar high with regards to administration, responsiveness, and snappy satisfaction. Regardless of whether you have to dispatch temperature-delicate vaccinations to patients rapidly, get your high-dollar gadgets to retailers for a major advancement, or send a basic part to a slowed-down sequential construction system inside a couple of hours, airship cargo is the arrangement. Silk Container Lines Ltd. gives the most extreme degrees of adaptability and improvement for all your air freight needs.
            </p>
            <p>
              We provide extensive Air Freight Services, making the world smaller for all cargo requirements with space reserved on the world’s leading commercial airlines to and from major destinations worldwide. The skilled airfreight staff’s guarantee services that will meet both time and price sensitive demands of the customer. For Cargo receiving, storing, pre-carting and stuffing we can use our Warehouse facilities at the cargo complex of Dhaka International Airport with ROUND-THE-CLOCK operational facilities. A rented warehouse with 3500 sft capacity is also at our possession for cargo waiting to be consolidated.
            </p>
          </div>
        </div>
     ...
     <section class="about" data-aos="fade-up">
        <div class="container">
          ...
          <div class="row">
            ...
            <div class="col-lg-6 pt-4 pt-lg-0">
              <h3>Our services comprise of:</h3>
              <ul>
                <li><i class="bi bi-check2-circle"></i> Airport to Airport Services</li>
                <li><i class="bi bi-check2-circle"></i> Consolidation Services</li>
                <li><i class="bi bi-check2-circle"></i>GO Handling</li>
                <li><i class="bi bi-check2-circle"></i>Palletization</li>
                <li><i class="bi bi-check2-circle"></i>Bar Code Scanning Facilities</li>
                <li><i class="bi bi-check2-circle"></i>Door to Door Delivery</li>
                <li><i class="bi bi-check2-circle"></i>Chartering</li>
                <li><i class="bi bi-check2-circle"></i>Project Cargo Handling</li>
              </ul>
            </div>

            <div class="col-lg-6">
                <img src="assets/img/air/air2.jpeg" class="img-fluid" alt="">
              </div>
          </div>
    ...
    <!-- End About Section -->
     ...
     <section class="about" data-aos="fade-up">
        <div class="container">
          ...
          <div class="row">
            <div class="col-lg-6">
              <img src="assets/img/air/a1.jpg" class="img-fluid" alt="">
            </div>
            <div class="col-lg-6 pt-4 pt-lg-0">
              <h3>A Strong, Predictable Supply Chain</h3>
              <h4>Build a strong, predictable supply chain backed by Silk Container Lines Ltd’s years of experience in international air freight shipping</h4>
              <ul>
                <li><i class="bi bi-check2-circle"></i> Put your time-sensitive cargo on the next available flight</li>
                <li><i class="bi bi-check2-circle"></i> Influence better rates by combining your shipments with others</li>
                <li><i class="bi bi-check2-circle"></i>Save money with conceded dispatching alternatives on your lower-need orders than can hold up a couple of days</li>
                <li><i class="bi bi-check2-circle"></i>Limit dealing with and potential harm for delicate shipments</li>
                <li><i class="bi bi-check2-circle"></i>Lessen stockroom stockpiling costs</li>
                <li><i class="bi bi-check2-circle"></i>Increase start to finish control and permeability over your flexible chain</li>
              </ul>
            </div>
          </div>

...
<head>
  ...
  <title>Services | Silk Container Lines Ltd</title>
        ...
        <div class="row">
          <div class="col-md-6 col-lg-3 d-flex align-items-stretch" data-aos="fade-up">
            <div class="icon-box icon-box-pink">
              ...
              <p class="description">The Silk Container Lines Ltd. ocean product range offers an assortment of administrations to meet your sea gracefully chain needs. Every item has been created to fulfill your high guidelines for door-to-door transport services.</p>
            </div>
          </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/ocean.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Ocean Freight</a></h5>
                <p class="card-text">Ocean freight is the method of transporting goods through the sea. It is an important part of cross-border trade that lets people move massive amounts of goods between countries.</p>
                <div class="read-more"><a href="{{ url('/ocean-freight') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/air.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="">Air Freight</a></h5>
                <p class="card-text">Air freight parcel delivery is the transfer and shipment of goods via an air carrier, which may be charter or commercial. Such shipments travel out of commercial and passenger ..</p>
                <div class="read-more"><a href="{{ url('/air-freight') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/consolidation.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Consolidation</a></h5>
                <p class="card-text">Cargo consolidation is the process of combining small shipments of many customers in one lot. On the opposite side, de-consolidation is the process of breaking down a large shipment into smaller...</p>
                <div class="read-more"><a href="{{ url('/consolidation') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/pomanagement.jpg" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">P.O.management</a></h5>
                <p class="card-text">PO Management in freight forwarding refers to the process of managing purchase orders (POs) for the shipment of goods. It involves coordinating the logistics and transportation of the goods to ensure that they are delivered</p>
                <div class="read-more"><a href="{{ url('/pomanagement') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              <div class="card-img">
                <img src="assets/img/services/warehouse.png" alt="...">
              </div>
              <div class="card-body">
                <h5 class="card-title"><a href="#">Warehouse</a></h5>
                <p class="card-text">Warehousing is the process of purchasing goods from a manufacturer and storing them before shipping them to another location for fulfillment. You can keep these items in a warehouse, spare room...</p>
                <div class="read-more"><a href="{{ url('/warehouse') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
          ...
          <div class="col-md-6 d-flex align-items-stretch" data-aos="fade-up">
            <div class="card">
              ...
              <div class="card-body">
                <h5 class="card-title"><a href="#">Custom Brokerage</a></h5>
                <p class="card-text">Customs clearance is a crucial part of the freight forwarding and logistics process. It involves adhering to the regulations and requirements set by the customs authority to ensure that goods are imported or exported legally and efficiently.</p>
                <div class="read-more"><a href="{{ url('/custom-brokerage') }}"><i class="bi bi-arrow-right"></i> Read More</a></div>
              </div>
            </div>
          </div>
        </div>
